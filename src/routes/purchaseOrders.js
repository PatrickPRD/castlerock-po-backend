    ...
    try {
      ...
      try {
        ...
        if (normalizedLineItems.length) {
          ...
          await syncCostItemsFromLineItems(conn, normalizedLineItems, req.user.id, 'po_line_item', result.insertId);
        }
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (normalizedLineItems.length) {
        ...
        await syncCostItemsFromLineItems(conn, normalizedLineItems, req.user.id, 'po_line_item', id);
      }
